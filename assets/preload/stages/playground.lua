function onCreate()
	-- background shit
	makeLuaSprite('playgroundBack', 'playgroundBack', -600, -200);
	setScrollFactor('playgroundBack', 0.9, 0.9);
	
	makeLuaSprite('playgroundFront', 'playgroundFront', -650, 600);
	setScrollFactor('playgroundFront', 0.9, 0.9);
	scaleObject('playgroundFront', 1.1, 1.1);
	...
	addLuaSprite('playgroundBack', false);
	addLuaSprite('playgroundFront', false);
